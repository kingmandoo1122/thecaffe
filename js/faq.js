...

{
    ...
    answer : "메뉴주문 시, 적립 예정 휴대번호 입력 or 더벤티 APP내 멤버십바코드 를 제시하여 스탬프를 적립할 수 있습니다. (※ 제조음료에 한함)"
}
,
{ 
    cate : "스탬프",
...
{ 
    cate : "회원",
    question : "더카페APP은 어디서 설치(다운로드)할 수 있나요?",
    answer : "더벤티 멤버십 APP을 모바일기기에 다운로드하여 회원가입 가능합니다. 단 가입 시, 국내 이동통신사의 본인명의 휴대전화번호로 인증이 필요하여 만14세 미만 회원은 가입이 불가능합니다."
...
{ 
    ...
    answer : "현재 더벤티 멤버십은 휴대폰번호가 아이디(ID)로 사용되어서 직접 변경은 불가능합니다. 더벤티 고객센터(1644-0513)로 문의바랍니다."
...
{ 
    ...
    answer : "기본 20oz(591mL)로 제공되고 있으나 일부 메뉴는 하프벤티 14oz(414mL) or 더벤티 사이즈 32oz(946mL)로 제공되오니 제품별 용량을 참고하여 이용해 주시기 바랍니다. "
...
{ 
    ...
    answer : "모바일상품권 이용 시, 현금영수증 발행 가능합니다.<br>더벤티 앱 픽업주문 시에는, 모바일상품권 조회 단계에서 현금영수증 발행여부를 선택할 수 있습니다. "
